...
window.geometry("997x270")

# course id
Label(window, text="Course Id:").place(x=20, y=20)
course_id = IntVar(value=1)
Entry(window, textvariable=course_id, state="readonly").place(x=80, y=20)
...
Entry(window, textvariable=teacher_name).place(x=112, y=185)
